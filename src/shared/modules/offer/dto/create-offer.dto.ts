...
export class CreateOfferDto {
  ...
  @IsNumber({}, { message: CreateUpdateOfferValidationMessage.rating.invalidType })
  ...
  @Validate(OneDecimalRule, { message: CreateUpdateOfferValidationMessage.rating.invalidType })
  @Type(() => Number)
