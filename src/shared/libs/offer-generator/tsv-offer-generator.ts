...
export class TSVOfferGenerator implements OfferGenerator {
  ...
  generate(): string {
    ...
    const amenities = getRandomItems<string>([AmenityType.AirConditioning, AmenityType.BabySeat, AmenityType.Breakfast, AmenityType.Fridge, AmenityType.LaptopFriendlyWorkspace, AmenityType.Towels, AmenityType.Washer]);
